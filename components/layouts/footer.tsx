    ...
    <div className="hidden md:flex w-full border-solid border-[#363636] border-y-[1px] mt-4">
      <div className=" border-solid border-[#363636] flex flex-row mt-auto text-white w-[95%] m-auto py-10">
        <div className="flex flex-col w-full m-2">
          <div className="w-[50%]">
            <h2 className="mb-4">NONTON MOVIE</h2>
            <p>
              Nonton Movie merupakan situs penyedia layanan streaming film dan
              ...
              lainnya. Nonton Movie berusaha untuk menyediakan layanan streaming
              ...
              diatas. Perlu diperhatikan Nonton Movie tidak menyediakan film
              maupun serial tv dari negara Indonesia.
            </p>
          </div>
        </div>
