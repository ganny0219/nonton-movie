...
function StarSeasonRating({
  ...
  return (
    <>
        ...
        <div className="flex flex-row items-center mt-2">
          ...
          {isMobile && (
            <div className="flex flex-1 justify-end pr-2">
              <div
                className={`text-sm bg-[#313131] px-4  rounded whitespace-nowrap`}
              >
                Your rating : {choose}
              </div>
            </div>
      ...
      {!isMobile && (
        <div>
          <div className={` bg-[#313131] px-4 rounded whitespace-nowrap`}>
            Your rating : {choose}
          </div>
        </div>
      )}
...
export default StarSeasonRating;
