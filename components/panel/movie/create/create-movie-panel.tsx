...
function CreateMoviePanel({ playerServerList, playerServerListJson }: Props) {
  ...
  useEffect(() => {
    if (movieData.playerUrl.length < 1) {
      const newPlayerSet = [];
...
export default CreateMoviePanel;
